...
Original file is located at
    https://colab.research.google.com/drive/15i5MpXtxJ-KWDihNFx-0stkfkEMA27Mz
...
for i in auto.tqdm(range(number_of_slices_to_try_to_generate)):
  try:
    for s in signatures:
      ...
      if fuzz.ratio(sig[1:], s[1:]) >= slices_fuzz_matching_threshold and signatures.index(s) != signatures.index(sig):
