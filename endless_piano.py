...
Original file is located at
    https://colab.research.google.com/drive/13Unjl4ZUSpo0XPYIkaSwgnxp0AyYsK4r
...
quarter_pairs = []
for qp in auto.tqdm(quarter_pairs1[0]):
  quarter_pairs.extend(TMIDI.Tegridy_Score_Slicer(qp, slices_length_in_miliseconds, overlap_notes=overlap_notes_per_slice, overlap_chords=False)[0])
print('=' * 70)
