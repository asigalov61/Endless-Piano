...
desired_maximum_fuzzy_match_percentage = 100 #@param {type:"slider", min:1, max:100, step:1}
desired_minimum_fuzzy_match_percentage = 90 #@param {type:"slider", min:0, max:99, step:1}
