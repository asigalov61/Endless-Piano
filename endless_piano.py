...
Original file is located at
    https://colab.research.google.com/drive/1tte9b8KEgz31K_LkOXn0uq7zrbF7dFQJ
...
quarter_pairs_split = False #@param {type:"boolean"}

if not quarter_pairs_split:
  ...
  for qp in auto.tqdm(quarter_pairs1[0]):
    quarter_pairs.extend(TMIDI.Tegridy_Score_Chords_Pairs_Generator(qp, shuffle_pairs=True, remove_single_notes=False)[0])
  print('=' * 50)
   
  print('Done!')
  print('Generated total of:', len(quarter_pairs), 'chords pairs.')
  print('Enjoy! :)')
  ...
  quarter_pairs = []
  for qp in auto.tqdm(quarter_pairs1[0]):
    quarter_pairs.extend(TMIDI.Tegridy_Sliced_Score_Pairs_Generator(qp, 250, shuffle_pairs=True)[0])
  print('=' * 50)

  print('Done!')
  print('Generated total of:', len(quarter_pairs), 'quarter chords pairs.')
  print('Enjoy! :)')
