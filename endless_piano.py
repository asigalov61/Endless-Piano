...
Original file is located at
    https://colab.research.google.com/drive/1tqJ-p0_QnkIyj1kbi6nHuIIE6JN_PKv9
...
#@title Download large model (GiantMIDI Dataset)
# %cd /content/
...
desired_number_of_notes = 500 #@param {type:"slider", min:50, max:500, step:50}
